...
import {
  ...
  zGetWorkspacesArchivedResponse,
  ...
  zPostWorkspacesArchiveBody,
  zPostWorkspacesArchiveResponse,
  zPostWorkspacesBody,
  ...
  zPostWorkspacesLeaveBody,
  zPostWorkspacesLeaveResponse,
  zPostWorkspacesResponse,
  zPostWorkspacesSwitchBody,
  zPostWorkspacesSwitchResponse,
  zPostWorkspacesUnarchiveBody,
  zPostWorkspacesUnarchiveResponse,
...
export const post = oc
  .route({
    ...
    method: 'POST',
    operationId: 'postWorkspacesArchive',
    path: '/workspaces/archive',
    tags: ['console'],
  })
  .input(z.object({ body: zPostWorkspacesArchiveBody }))
  .output(zPostWorkspacesArchiveResponse)
...
export const get = oc
  .route({
    inputStructure: 'detailed',
    method: 'GET',
    operationId: 'getWorkspacesArchived',
    path: '/workspaces/archived',
    tags: ['console'],
  })
  .output(zGetWorkspacesArchivedResponse)
...
export const post75 = oc
  .route({
    inputStructure: 'detailed',
    method: 'POST',
    operationId: 'postWorkspacesLeave',
    path: '/workspaces/leave',
    tags: ['console'],
  })
  .input(z.object({ body: zPostWorkspacesLeaveBody }))
  .output(zPostWorkspacesLeaveResponse)
...
export const get96 = oc
  .route({
    inputStructure: 'detailed',
    method: 'GET',
    operationId: 'getWorkspacesPolicy',
    path: '/workspaces/policy',
    tags: ['console'],
  })
  .output(zGetWorkspacesPolicyResponse)
...
export const post77 = oc
  .route({
    inputStructure: 'detailed',
    method: 'POST',
    operationId: 'postWorkspacesUnarchive',
    path: '/workspaces/unarchive',
    tags: ['console'],
  })
  .input(z.object({ body: zPostWorkspacesUnarchiveBody }))
  .output(zPostWorkspacesUnarchiveResponse)
